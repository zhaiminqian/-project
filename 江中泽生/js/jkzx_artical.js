	...
	kxy_news={	
		...
		news_ajax:function(){
			...
			function ajax_news(){
				$.ajax({
					url:'http://www.jzzsyy.com:2403/info',
					data:{id:_id},
					dataType:"json",
					type:"get",
					error:function(){
					...
					success:function(e){
						...
						$(".nc_loading").hide()
					    var html=''				 
		              	html='<p class="nc_list_title"><a href="javascript:;"><span>'+e.title+'</span><span class="nc_list_date">'+e.date+'</span></a></p><p>'+unescape(e.content)+'</p>'
		           		$("#list_one").html(html)
